...
- **New slash commands.** `/cg-spec`, `/cg-implement`, `/cg-drifted`, `/cg-fix`, `/cg-relink` are installed into Claude Code so you can drive the spec workflow from the prompt without remembering CLI syntax.
