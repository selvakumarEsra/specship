/* Lucide-style icon set. <Icon name="..." /> — 24 viewBox, stroke. */
(function () {
  const P = {
    // nav + concepts
  ...
  // tile: render inside a rounded tile bg. mono: single-gradient fill.
  function LogoMark({ size = 24, tile = true, glow = true }) {
    const edge = "rgba(150,165,200,0.5)";
    const inner = React.createElement("g", { transform: "translate(4.6 4.6) scale(0.715)" },
      React.createElement("path", { d: "M5 16 H11 M11 9 L23 16 L11 23", stroke: edge, strokeWidth: 1.9, strokeLinecap: "round", strokeLinejoin: "round", fill: "none" }),
      React.createElement("line", { x1: 11, y1: 9, x2: 11, y2: 23, stroke: "rgba(150,165,200,0.4)", strokeWidth: 1.9, strokeLinecap: "round" }),
      React.createElement("circle", { cx: 23, cy: 16, r: 3.6, fill: "url(#ssLead)" }),
      React.createElement("circle", { cx: 11, cy: 9, r: 2.9, fill: "#A586F5" }),
      React.createElement("circle", { cx: 11, cy: 23, r: 2.9, fill: "#46C26B" }),
      React.createElement("circle", { cx: 5, cy: 16, r: 2.1, fill: "#29D2BE" }));
    return React.createElement("svg", { width: size, height: size, viewBox: "0 0 32 32", fill: "none",
      ...
      React.createElement("defs", null,
        React.createElement("linearGradient", { id: "ssTile", x1: 0, y1: 0, x2: 32, y2: 32, gradientUnits: "userSpaceOnUse" },
          React.createElement("stop", { stopColor: "#12161E" }), React.createElement("stop", { offset: 1, stopColor: "#0B0D11" })),
        React.createElement("linearGradient", { id: "ssLead", x1: 18, y1: 11, x2: 26, y2: 21, gradientUnits: "userSpaceOnUse" },
          React.createElement("stop", { stopColor: "#6FA0F6" }), React.createElement("stop", { offset: 1, stopColor: "#5B93F2" }))),
      tile && React.createElement("rect", { width: 32, height: 32, rx: 7.2, fill: "url(#ssTile)" }),
      tile && React.createElement("rect", { x: 0.5, y: 0.5, width: 31, height: 31, rx: 6.7, fill: "none", stroke: "rgba(255,255,255,0.08)" }),
      inner);
  }
