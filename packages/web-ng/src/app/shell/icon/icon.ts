...
const PATHS: Record<string, string> = {
  ...
  palette: '<circle cx="12" cy="12" r="9"/><circle cx="7.5" cy="10.5" r="1"/><circle cx="12" cy="7" r="1"/><circle cx="16.5" cy="10.5" r="1"/><path d="M12 21a3 3 0 0 1 0-6c1.5 0 2 1 3.5 1a2 2 0 0 0 0-4"/>',
};
