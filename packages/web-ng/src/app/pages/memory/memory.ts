...
/**
 * Render the Markdown subset SpecShip's CLAUDE.md files actually use into
 * HTML with semantic classes. All styling lives in memory.scss — no inline
 * styles so theme variables stay authoritative.
 *
 * Supported:
 *   - h1..h4 (`#`, `##`, `###`, `####`)
 ...
 * text — keep the renderer small; if you need a full GFM parser, swap to
 * markdown-it. The CLAUDE.md surface this page targets stays within this
 * subset.
 */
