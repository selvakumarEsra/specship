 ...
 * ```
 */
export class SpecShipError extends Error {
 ...
 */
export class FileError extends SpecShipError {
 ...
 */
export class ParseError extends SpecShipError {
  readonly filePath: string;
 ...
 */
export class DatabaseError extends SpecShipError {
 ...
 */
export class SearchError extends SpecShipError {
 ...
 */
export class VectorError extends SpecShipError {
  constructor(message: string, operation: string, cause?: Error) {
 ...
 */
export class ConfigError extends SpecShipError {
