 ...
 */
const RELAUNCH_GUARD_ENV = 'SPECSHIP_WASM_RELAUNCHED';
 ...
 */
export const HOST_PPID_ENV = 'SPECSHIP_HOST_PPID';
 ...
 * disabled via SPECSHIP_NO_RELAUNCH.
 *
...
export function relaunchWithWasmRuntimeFlagsIfNeeded(scriptPath: string): void {
  ...
  if (process.env.SPECSHIP_NO_RELAUNCH) return;
