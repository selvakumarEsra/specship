...
**JIRA integration (opt-in, `specship install --with-jira`):** `specship_jira_add_task` · `specship_jira_coverage` · `specship_jira_issue` · `specship_jira_issues` · `specship_jira_pick` · `specship_jira_publish` · `specship_jira_start` · `specship_jira_track` · `specship_jira_transition`
